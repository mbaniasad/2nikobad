...
dsName='GAR-cls-acl10'
Language_specific_nonbreaking_prefixes= 'de'
...
tokenizer_cmd = [absolute_tokenizer_path, '-l', Language_specific_nonbreaking_prefixes, '-q', '-']
...
def main():
    global absolute_dataset_path, dsName
